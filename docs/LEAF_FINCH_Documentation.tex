...
\vfill
\noindent\textbf{Associated article (accepted; final issue/page data pending):}\\
Vijayakumar Anand, Rafał Stojek, and Rafał Kotyński, ``Learned binary amplitude mask designs for Fresnel incoherent correlation holography'', \emph{Optics Letters} (posted 08/10/2026), doi: \href{https://doi.org/10.1364/OL.609636}{10.1364/OL.609636}.
...
If \software{} contributes to a publication, use the citation stored in \texttt{CITATION.cff} and \texttt{CITATION.bib}. The article is accepted and has a DOI, while final volume, issue, and page data are still pending:
\begin{quote}
Vijayakumar Anand, Rafał Stojek, and Rafał Kotyński, ``Learned binary amplitude mask designs for Fresnel incoherent correlation holography'', \emph{Optics Letters} (posted 08/10/2026), doi: \href{https://doi.org/10.1364/OL.609636}{10.1364/OL.609636}.
\end{quote}
